...
internal class PaletteMenu
{
    ...
    private readonly Model _model = Model.FromFile("InkBottle.glb");
    private readonly Model _swatchModel = Model.FromFile("InkSplat.glb");

    private Pose _pose = new Pose(-.4f, 0, -0.4f, Quat.LookDir(1, 0, 1));
    private float _size = 2 * U.cm;
    ...
    private void SetColor(float hue, float saturation, float value)
    {
        ...
        _value = value;
        PaintColor = Color.HSV(hue, saturation, value);
